...
import { MAIN_PHONE, MAIN_WHATSAPP, MAIN_ADDRESS } from '../constants';
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
               ...
               <div className="p-8 bg-luxury-black rounded-3xl border border-white/5 blue-glow">
                  ...
                  <a href={`https://wa.me/${MAIN_WHATSAPP}`} className="text-white font-bold hover:text-brand-blue transition-colors">Start Chat</a>
               </div>
            </div>
             ...
             {!isSubmitted ? (
                   ...
                   {formType === 'message' ? (
                     ...
                     >
                       ...
                       <button 
                         type="submit"
                         disabled={submitting}
                         className="w-full mt-2 py-4.5 bg-brand-blue text-white font-bold rounded-xl hover:bg-white hover:text-black transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 shadow-lg shadow-brand-blue/20"
                       >
               ...
               >
                 ...
                 <p className="text-gray-400 text-sm max-w-sm leading-relaxed mb-8">
                   {formType === 'message' 
                     ? "Thank you for reaching out to Eye-Q Optical. Our clinical and support team looks forward to assisting you and will respond within 24 hours."
                     : `Thank you for your interest in joining Eye-Q Optical as a ${careerPosition}. We have received your CV (${cvFile?.name}) and will review your credentials immediately.`
                   }
                 </p>
                 <button
                   onClick={handleReset}
